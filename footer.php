...
<div id="footer"><?php wp_footer(); ?>
    ...
    <div id="footerall">
        <div id="ceop">
            <a href="http://www.ceop.gov.uk/"><img
                    src="<?php bloginfo('template_directory'); ?>/images/CEOPReportBtn.gif"></a>
        </div>
    ...
    <div id="copyright"><p>© <?php bloginfo('name'); ?>, all rights reserved<br/>
            Powered by <a href="http://wordpress.org/">WordPress</a> | <a href="http://www.iscout4wordpress.org.uk">i.SCOUT
                4 WordPress</a> theme by <a href="http://www.hawesweb.co.uk">hawesWeb Productions</a></p></div>
