...
<?php if ($comments) : ?>
    <h3 id="comments"><?php comments_number('No Comment', 'One Comment', '% Comments'); ?> <a href="#respond"
                                                                                              title="<?php _e("Leave a comment"); ?>">&raquo;</a>
    </h3>
    <ul class="commentlist">
        ...
        <div class="commentlist">
            ...
            <li id="comment-<?php comment_ID() ?>" <?php if ($isByAuthor) {
                echo 'class="my_comment"';
            } ?>>
                ...
                <div class="clearfloat">
                    ...
                    <div class="commenttext">
                        <cite><strong><?php comment_author_link() ?> <?php if ($isByAuthor) {
                                    echo '(author)';
                                } ?> </strong> said: </cite>
    ...
    <?php else : ?>
        ...
        <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
            ...
            <?php else : ?>
                ...
                <p>Add your comment below, or <a href="<?php trackback_url(true); ?>" rel="trackback">trackback</a> from
                    your own site. You can also <?php comments_rss_link('subscribe to these comments'); ?> via RSS.</p>
            ...
            <p>This is a Gravatar-enabled weblog. To get your own globally-recognized-avatar, please register at <a
                    href="http://www.gravatar.com">Gravatar</a>.</p>
