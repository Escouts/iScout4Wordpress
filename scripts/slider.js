...
SLIDE.height = function () {
    return{
        set: function (e, h, s, d) {
            e = typeof e == 'object' ? e : $(e);
            var oh = e.offsetHeight, ho = e.style.height || SLIDE.style.val(e, 'height');
            ho = oh - parseInt(ho);
            var hd = oh - ho > h ? -1 : 1;
            clearInterval(e.si);
            e.si = setInterval(function () {
                SLIDE.height.tw(e, h, ho, hd, s)
            }, 20)
        },
...
SLIDE.alpha = function () {
    return{
        set: function (e, a, s) {
            e = typeof e == 'object' ? e : $(e);
            var o = e.style.opacity || SLIDE.style.val(e, 'opacity'),
                d = a > o * 100 ? 1 : -1;
            e.style.opacity = o;
            clearInterval(e.ai);
            e.ai = setInterval(function () {
                SLIDE.alpha.tw(e, a, d, s)
            }, 20)
        },
        tw: function (e, a, d, s) {
